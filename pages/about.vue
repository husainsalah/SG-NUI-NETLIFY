...
<template>
  <div>
      ...
      <div class="flex bg-white grid grid-flow-col">
        ...
        >
          ...
          <div class="flex mb-4 tracking-wide leading-8">
            ...
            neighbors, and the city of Detroit. The exhibition titled Free Jazz, curated by Kerstin Niemann, showcased
      ...
      <div class="flex flex-col z-10">
        ...
        >
          ...
          <NCarouselItem :style="{ width: '60%' }">
            ...
            <div class="sketch-title">note: inspired by the female groups of the motown era</div>
          </NCarouselItem>
    ...
    <section class="max-w-screen mx-auto mt-4">
      <div class="grid pl-8 pr-8 max-w-xlg mx-full bg-white space-x-8 grid grid-flow-col">
        ...
        <div class="col-span-8 pl-8 pr-8 max-w-xlg mx-full text-2xl hairilne text-gray-dark">
          ...
          <div class="mb-4 tracking-wide leading-8">
            3AM Thought: A civilization of beings who were reduced to inexpensive vessels of function. But slowly begin
            to reappear after the material has been tossed aside. This is the visual story of All-Dee People - a story
            of faces.
          </div>
          <div class="mb-4 tracking-wide leading-8">
          ...
          <div class="mb-4 tracking-wide leading-8">
            3AM Thought: All-Dee People, even though they lost their original identity to the "everydayness" they never
            forgot where they came from. And their hope is to one day totally break free of their chemically based
            composition and be normal again…whatever that is.This restoration process begins the day the everydayness
            stops.
          </div>
          <div class="mb-4 tracking-wide leading-8">
            3AM Thought: Listening to music doesn’t directly influence my work, but it does affect my mood which helps
            the mobility of my work. Fragments in my head join other fragments and form new ideas.
          </div>
        </div>
      </div>
    </section>
    <section>
      ...
      >
        <video
          ...
          loop
          class="flex"
          poster="~/assets/images/sg-video-poster.png"
        >
          <source
    ...
    <section>
      <div class="grid p-8 max-w-xlg mx-full bg-white space-x-8 grid grid-flow-col">
        <div class="col-span-12 lg:col-span-2">
          ...
          >
            ...
            <label class="inline mb-6 p-8">
              ...
              <input
                type="text"
                name="name"
                class="inline w-full m-8 p-1 mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
            ...
            <div class="inline-block mb-6">
              <button
                type="submit"
                class="h-10 px-5 p-1 m-8 text-indigo-100 bg-indigo-700 rounded-lg transition-colors duration-150 focus:shadow-outline hover:bg-indigo-800"
              >
                Sign up
              </button>
            </div>
    ...
    <section class="max-w-screen mx-auto pl-96 pr-96">
      <div class="grid p-8 max-w-xlg mx-full bg-white space-x-8 grid grid-flow-col">
        <div class="col-span-12 lg:col-span-2">
          <h1 class="p-8 text-6xl tracking-tighter leading-11 h-full">
            <NGradientText
