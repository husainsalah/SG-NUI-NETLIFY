  ...
  <div>
    <div class="columns-1 lg:col-span-2">
      <h1 class="flex text-6xl tracking-tighter leading-11 h-full">
        <NGradientText
          ...
          :size="36"
        >
          Alia Benabdellah, Docteure en Géographie Humaine, <br />in conversation with musician and artist Scott Grooves
          on<br />
          August 8, 2023
        </NGradientText>
      </h1>
    ...
    <div class="grid-flow-col auto-cols-min-2 gap-5">
      <div class="p-2 w-50 rounded-lg text-2xl font-thin transition-all">
        ...
        <p class="p-8">A. Do you remember going to the DIA or artistic places in Detroit, growing up?</p>
        <p class="p-8">S. Yes. In school, we would have field trips to museums.</p>
        <p class="p-8">A. Do you remember your feelings in front of this very classical art?</p>
        <p class="p-8">
        ...
        <p class="p-8">S. I would think so. Absolutely. Far away from building an underground.</p>
        <p class="p-8">A. How can music, Scott, inspire the making of art according to you?</p>
        <p class="p-8">
        ...
        <p class="p-8">A. How did you start making art during that period?</p>
        <p class="p-8">
        ...
        <p class="p-8">A. You don't see a separation between the two?</p>
        <p class="p-8">S. No, a lot of times I don't. But sometimes I can feel the separation.</p>
        <p class="p-8">
        ...
        <p class="p-8">A. Which one?</p>
        <p class="p-8">S. The one that's right here [pointing it out to me].</p>
        <p class="p-8">A. On the gray wall?</p>
        <p class="p-8">
        ...
        <p class="p-8">A. For sure! How's your relationship to visual art evolved over the last three decades?</p>
        <p class="p-8">S. Wow, that's a long time. It's been three decades!</p>
        <p class="p-8">A. [laughs] Oui. Did you have any classical art education?</p>
        <p class="p-8">S. No, I didn't.</p>
        <p class="p-8">A. Tell me about this relationship with visual art please.</p>
        <p class="p-8">
        ...
        <p class="p-8">A. Completely. How did the space change your art? Or how did it influence it?</p>
        <p class="p-8">
        ...
        <p class="p-8">A. Did your art allow you to find this imagination?</p>
        <p class="p-8">
        ...
        <p class="p-8">S. What challenges you as an artist, Scott?</p>
        <p class="p-8">
        ...
        <p class="p-8">A. You're starting to have quite an important body of work now.</p>
        <p class="p-8">S. Yes. I have a certain thing that I do.</p>
        <p class="p-8">A. Do you get rid of anything?</p>
        <p class="p-8">S. Well when you turn the recording off, I tell you [laughs]. I tell you a secret.</p>
        <p class="p-8">
        ...
        <p class="p-8">A. Art is self-exploration.</p>
        <p class="p-8">
        ...
        <p class="p-8">A. That's organic.</p>
        <p class="p-8">
        ...
        <p class="p-8">A. Yes you wanted to include people in this process.</p>
        <p class="p-8">
        ...
        <p class="p-8">A. But I feel like it's always the case.</p>
        <p class="p-8">S. That's always the case.</p>
        <p class="p-8">A. You appreciate the new, the different.</p>
        <p class="p-8">
        ...
        <p class="p-8">A. Thank you very much Scott! I can’t wait to see the exhibition.</p>
        <p class="p-8">Alia Benabdellah, Docteure en Géographie Humaine and Teacher.</p>
      </div>
    </div>
  </div>
</template>
