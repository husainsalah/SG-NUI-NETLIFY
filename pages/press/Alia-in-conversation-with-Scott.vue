...
<template>
  <div>
    ...
    <div class="grid-flow-col auto-cols-min-2 gap-5">
      <div class="w-50 rounded-lg text-2xl hairline transition-all">
        <NDivider></NDivider>
        <p>
        ...
        <p class="pt-8">
          ...
          opportunity to sit down with Scott Grooves to explore his newfound passion for visual art and delve into his
          unique connection between electronic music and personal expression. During their conversation, Grooves shared
          his insights and perspectives on this creative journey, shedding light on the intriguing intersection of
          different art forms.
        </p>
        <p class="pt-8">
